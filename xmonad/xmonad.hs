...
myWorkspaces =
  [
    "7:Explore",  "8:Misc", "9:Entertainment",
    "4:Tinkering",  "5:Code", "6:Reading",
    "1:Dashboards",  "2:Social", "3:Project",
    "0:Ubuntu",    "Extr1", "Extr2"
  ]

startupWorkspace = "5:Code"  -- which workspace do you want to be on after launch?
...
-- layouts.
myLayouts =
  onWorkspace "2:Social" chatLayout
  $ onWorkspace "1:Dashboards" gimpLayout
...
myKeyBindings =
  [
    ((myModMask, xK_b), spawn "brave-browser --new-window google.com")
    , ((myModMask, xK_a), sendMessage MirrorShrink)
    , ((myModMask, xK_z), sendMessage MirrorExpand)
    , ((myModMask, xK_bracketleft), sendMessage Shrink)
    , ((myModMask, xK_bracketright), sendMessage Expand)
    ...
    , ((myModMask, xK_Down), windows W.focusDown)
    , ((myModMask, xK_Up), windows W.focusUp)
    , ((myModMask .|. shiftMask, xK_Down), windows W.swapDown)
    , ((myModMask .|. shiftMask, xK_Up), windows W.swapUp)    
    , ((myModMask .|. shiftMask, xK_Left), windows W.swapDown)
    , ((myModMask .|. shiftMask, xK_Right), windows W.swapUp)    
    , ((0, 0x1008FF12), spawn "amixer -q set Master toggle")
    , ((0, 0x1008FF11), spawn "amixer -q set Master 10%-")
    , ((0, 0x1008FF13), spawn "amixer -q set Master 10%+")
    , ((0, 0x1008FF02), spawn "brightnessctl set +10%")
    , ((0, 0x1008FF03), spawn "brightnessctl set 10%-")
    , ((myModMask, xK_o), SM.submap . M.fromList $
        [ ((0, xK_b), spawn "brave-browser --new-window google.com")
        , ((0, xK_s), spawn "slack")
        , ((0, xK_n), spawn "notion-snap-reborn")
        -- Add more app launchers here
        ])
  ]
